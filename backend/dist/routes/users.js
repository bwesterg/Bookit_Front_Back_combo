...
router.post("/register", [
    ...
    (0, express_validator_1.check)("firstName", "First name required").isString(),
    (0, express_validator_1.check)("lastName", "Last name required").isString(),
    (0, express_validator_1.check)("email", "Email required").isEmail(),
    (0, express_validator_1.check)("password", "Password requires min 6 characters").isLength({ min: 6 }),
