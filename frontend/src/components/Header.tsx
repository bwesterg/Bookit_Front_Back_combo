        ...
        <span className="flex space-x-2">
          {isLoggedIn ? (
            <>
              ...
              <Link className="flex items-center text-white px-3 font-bold hover:bg-purple-600"to="/my-bookings">My Hotels</Link>
              <SignOutButton />
            </>
          ) : (
            <Link 
              className="flex bg-white items-center text-purple-600 
